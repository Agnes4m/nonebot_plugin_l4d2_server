...
global_config_form = Form(
    ...
    body=[
        ...
        InputText(label='后台管理用户名', name='web_username', value='${total_enable}',
                  labelRemark=Remark(shape='circle',
                                     content='登录本后台管理所需要的用户名。')),
        InputPassword(label='后台管理密码', name='web_secret_key', value='${web_password}',
                      labelRemark=Remark(shape='circle',
